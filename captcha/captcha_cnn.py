...
def _resolve_against_here(value: str, default_name: str) -> str:
    if not value:
        return os.path.normpath(os.path.join(HERE, default_name))
    if os.path.isabs(value):
        return os.path.normpath(value)
    return os.path.normpath(os.path.join(HERE, value))


DATA = _resolve_against_here(os.environ.get("CAPTCHA_DATA_DIR", ""), "data")
OUT = _resolve_against_here(os.environ.get("CAPTCHA_OUT_DIR", ""), "cnn_out")
SEED = 42
TEST_FRAC = 0.05
W, H = 150, 50
N_CHARS = 5
